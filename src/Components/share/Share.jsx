...
import { Cancel, EmojiEmotions, Room, VideoLibrary } from '@material-ui/icons';
...
const Share = () => {
  ...
  const submitForm = async (e) => {
    ...
    if (image) {
      ...
      try {
        let postRes = await axios.post('http://localhost:5000/api/v1/post', 
        data, 
        {
          headers: {
      ...
      <div className="share__wrapper">
        ...
        
        {
          image ? (
            ...
            <div className="share__preview__container">
              <video className="share__img__preview" autoPlay="true" controls>
        ...
        <form className="share__bottom" onSubmit={submitForm}>
          <div className="share__options">
            ...
            <label htmlFor="video" className="share__option">
              <VideoLibrary htmlColor="red" className="share__icon" />
